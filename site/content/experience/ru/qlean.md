...
media:
  ...
  - src: "/screenshots/qlean/qlean-apps.png"
    caption: "Приложения Qlean"
  - src: "/screenshots/qlean/qlean-warehouse-main.png"
    caption: "Складское приложение (управление грузами)"
  - src: "/screenshots/qlean/qlean-agents-main.png"
    caption: "Приложение для сотрудников ПВЗ"
  ...
  - src: "/screenshots/qlean/mobile-core-tests.png"
    caption: "Юнит и рендер-тесты мобильного ядра"
  - src: "/screenshots/qlean/mobile-core-test-coverage.png"
    caption: "Покрытие ядра тестами (>90%)"
...
- Перестроил процесс разработки так, что приложения собираются из переиспользуемых модулей как из кубиков: модули маленькие, независимые, слабо-связанные; часть — общие (`authentication`, `devtools`), часть — локальные (`courierDocuments`). До перестройки дублирование логики между приложениями достигало 60–70%, после - процентов 15-20%.
...
- **~100 технических интервью**, успешный онбординг и обучение новых сотрудников.
