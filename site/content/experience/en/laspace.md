---
company: "LaSpace"
role: "Deputy Head of Engineering (part-time)"
period:
  from: "2023-04"
  to: "2024-04"
order: 2
...
highlights:
  ...
  - XWIKI requirements system (IBM DOORS analogue)
---

- Built a modern engineering process inside an aerospace enterprise.
- Introduced Gitflow, CI/CD, code review, red-green-refactor.
- Mentored and trained engineers, ran interviews.
- Built an automated project-requirements management system on top of XWIKI.
